...
function carregarObjetos() {
    ...
    pedido2.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            objetos.forEach(objeto => {
                ...
                imagem.alt = 'Imagem do objeto perdido';
    ...
    pedidoObjetosPerdidosSeus.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            //DIV QUE VAI CONTER OS OBJETOS Achados
...
function carregarObjetosComCategoria(categoriaSearch) {
    let pedido2 = xhttp = new XMLHttpRequest();
    let numObjetos = 0;
    pedido2.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
    ...
    pedido2.open("GET", "/api/policia/" + idPolicia + "/encontrarObjetoPorCategoria/" + categoriaSearch, true)
    pedido2.send();
...
function carregarObjetosComPesquisa(searchTerm) {
    let pedido2 = xhttp = new XMLHttpRequest();
    let numObjetos = 0;
    pedido2.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
    ...
    pedido2.open("GET", "/api/policia/" + idPolicia + "/encontrarObjetoPorDescricao/" + searchTerm, true)
    pedido2.send();
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (let i = 0; i < categorias.length; i++) {
                ...
                a.addEventListener('click', function () {
                    ...
                    window.location.href = '/buscaObjPerdidos';
                });
