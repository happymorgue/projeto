...
<meta charset="UTF-8" />
  ...
  <title>Cogitavi - Editar Achados</title>
  ...
  <link rel="stylesheet" href="../css/editAchados.css" />
</head>
<body>
 ...
 <nav class="navbar navbar-expand-lg bg-dark navbar-dark cor-nav-bar py-2 fixed-top">
  ...
  <h1 class=" text-center pt-5"> Aqui será a página para o polícia editar e remover objetos achados.</h1>
